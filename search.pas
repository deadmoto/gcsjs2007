...
type
  ...
  public
    ...
    cur: array[0..17] of string;//текущие наименовани€ в пол€х ввода в combobox
    curind: array[0..17] of integer;//индексы, соответствующие текущим наименовани€м в пол€х ввода
    rsel: boolean;
  end;
...
function TForm33.SearchPriv(s: string): integer;
{*******************************************************************************
*******************************************************************************}
var
  i: integer;
