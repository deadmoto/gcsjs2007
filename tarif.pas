  ...
  begin
    ...
    begin
      ...
      begin
        ...
        SetParam(Parameters, 'id', StrToInt(Edit3.Text));
        SetParam(Parameters, 'name', Edit1.Text);
        SetParam(Parameters, 'tarif', StrToFloat(Edit2.Text));
        if isNorm then
          SetParam(Parameters, 'norm', StrToFloat(Edit4.Text));
        ExecSQL;
        FillTarif(MainForm.bpath, nam, MainForm.rdt, MainForm.dist, MainForm.codedbf);
        oldid := StrToInt(Edit3.Text);
      end
      else
